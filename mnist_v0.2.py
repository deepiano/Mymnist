...
with tf.name_scope("layer1") as scope:
    ...
    #W1 = tf.Variable(tf.random_normal([784, 256]), initializer=tf.contrib.layers.xavier_initializer(), name="weight1")
...
with tf.name_scope("layer2") as scope:
    ...
    #W2 = tf.Variable(tf.random_normal([256, 256]), initializer=tf.contrib.layers.xavier_initializer(), name="weight2"
...
with tf.name_scope("layer3") as scope:
    ...
    #W3 = tf.Variable(tf.random_normal([256, 10]), initializer=tf.contrib.layers.xavier_initializer(), name="weight3")
...
with tf.Session() as sess:
    ...
    writer = tf.summary.FileWriter("./logs/v0.2")
